...
//                    // Ana sayfayı aç
//                    replaceFragment(new HomeFragment());
//                    drawerLayout.closeDrawer(GravityCompat.START); // Menüyü kapat
//                    return true;
...
//                    // Burada paylaşma işlemi başlatılabilir
//                    drawerLayout.closeDrawer(GravityCompat.START); // Menüyü kapat
//                    return true;
//                } else if (id == R.id.nav_about) {
//                    // Hakkında sayfasını aç
//
//                    // Burada hakkında sayfası açılabilir
//                    drawerLayout.closeDrawer(GravityCompat.START); // Menüyü kapat
//                    return true;
//                } else if (id == R.id.nav_logout) {
//                    // Çıkış yap işlemi
//                    // Burada çıkış yap işlemi gerçekleştirilebilir
//                    drawerLayout.closeDrawer(GravityCompat.START); // Menüyü kapat
//                    return true;
//                }
//                return false;
...
//        });
    ...
    public void showBaba(MenuItem menuItem)
    {
